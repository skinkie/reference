...
line_hasd = Line(id=getId(Line, codespace, "HASD"), version=version.version, name=MultilingualString(value="Holwerd - Ameland (Sneldienst)"),
              monitored=False,
              responsibility_set_ref_attribute=getId(ResponsibilitySet, codespace, short_name),
              ...
              accessibility_assessment=AccessibilityAssessment(id=getId(AccessibilityAssessment, codespace, "HASD"), version=version.version,
                                                               mobility_impaired_access=LimitationStatusEnumeration.TRUE)
              )
...
line_lssd = Line(id=getId(Line, codespace, "LSSD"), version=version.version, name=MultilingualString(value="Lauwersoog - Schiermonnikoog (Sneldienst)"),
              monitored=False,
              responsibility_set_ref_attribute=getId(ResponsibilitySet, codespace, short_name),
              ...
              accessibility_assessment=AccessibilityAssessment(id=getId(AccessibilityAssessment, codespace, "LSSD"), version=version.version,
                                                               mobility_impaired_access=LimitationStatusEnumeration.TRUE)
              )

lines = [line_ha, line_hasd, line_ls, line_lssd]


rp_h = RoutePoint(id=getId(RoutePoint, codespace, "H"), version=version.version, location=LocationStructure2(pos=Pos(value=[187721, 601113], srs_dimension=2)))
rp_a = RoutePoint(id=getId(RoutePoint, codespace, "A"), version=version.version, location=LocationStructure2(pos=Pos(value=[180750, 605311], srs_dimension=2)))
rp_l = RoutePoint(id=getId(RoutePoint, codespace, "L"), version=version.version, location=LocationStructure2(pos=Pos(value=[208889, 603004], srs_dimension=2)))
rp_s = RoutePoint(id=getId(RoutePoint, codespace, "S"), version=version.version, location=LocationStructure2(pos=Pos(value=[203187, 609466], srs_dimension=2)))

route_points = [rp_h, rp_a, rp_l, rp_s]
...
route_ha = Route(id=getId(Route, codespace, "H-A"), version=version.version,
                 distance=Decimal('17000'),
                 flexible_line_ref_or_line_ref=getRef(line_ha),
                   ...
                   points_in_sequence=PointsOnRouteRelStructure(point_on_route=[
                       PointOnRoute(id=getId(PointOnRoute, codespace, "H-A-H"), version=version.version, order=1, choice_1=getRef(rp_h), onward_route_link_ref=getRef(rl_ha, RouteLinkRefStructure)),
                       PointOnRoute(id=getId(PointOnRoute, codespace, "H-A-A"), version=version.version, order=2, choice_1=getRef(rp_a)),
                   ])
                   )

route_ah = Route(id=getId(Route, codespace, "A-H"), version=version.version,
                 distance=Decimal('17000'),
                 flexible_line_ref_or_line_ref=getRef(line_ha),
                   direction_type=DirectionTypeEnumeration.INBOUND,
                   points_in_sequence=PointsOnRouteRelStructure(point_on_route=[
                       PointOnRoute(id=getId(PointOnRoute, codespace, "A-H-H"), version=version.version, order=1, choice_1=getRef(rp_a), onward_route_link_ref=getRef(rl_ah, RouteLinkRefStructure)),
                       PointOnRoute(id=getId(PointOnRoute, codespace, "A-H-A"), version=version.version, order=2, choice_1=getRef(rp_h)),
                   ])
                   )

route_ha = Route(id=getId(Route, codespace, "L-S"), version=version.version,
                 distance=Decimal('12000'),
                 flexible_line_ref_or_line_ref=getRef(line_ls),
                   direction_type=DirectionTypeEnumeration.OUTBOUND,
                   points_in_sequence=PointsOnRouteRelStructure(point_on_route=[
                       PointOnRoute(id=getId(PointOnRoute, codespace, "L-S-L"), version=version.version, order=1, choice_1=getRef(rp_l), onward_route_link_ref=getRef(rl_ls, RouteLinkRefStructure)),
                       PointOnRoute(id=getId(PointOnRoute, codespace, "L-S-S"), version=version.version, order=2, choice_1=getRef(rp_s)),
                   ])
                   )

route_ah = Route(id=getId(Route, codespace, "S-L"), version=version.version,
                 distance=Decimal('12000'),
                 flexible_line_ref_or_line_ref=getRef(line_ls),
                   direction_type=DirectionTypeEnumeration.INBOUND,
                   points_in_sequence=PointsOnRouteRelStructure(point_on_route=[
                       PointOnRoute(id=getId(PointOnRoute, codespace, "S-L-S"), version=version.version, order=1, choice_1=getRef(rp_s), onward_route_link_ref=getRef(rl_sl, RouteLinkRefStructure)),
                       PointOnRoute(id=getId(PointOnRoute, codespace, "S-L-L"), version=version.version, order=2, choice_1=getRef(rp_l)),
                   ])
                   )

route_hasd = Route(id=getId(Route, codespace, "H-A-SD"), version=version.version,
                 distance=Decimal('17000'),
                 flexible_line_ref_or_line_ref=getRef(line_hasd),
                   direction_type=DirectionTypeEnumeration.OUTBOUND,
                   points_in_sequence=PointsOnRouteRelStructure(point_on_route=[
                       PointOnRoute(id=getId(PointOnRoute, codespace, "H-A-SD-H"), version=version.version, order=1, choice_1=getRef(rp_h), onward_route_link_ref=getRef(rl_ha, RouteLinkRefStructure)),
                       PointOnRoute(id=getId(PointOnRoute, codespace, "H-A-SD-A"), version=version.version, order=2, choice_1=getRef(rp_a)),
                   ])
                   )

route_ahsd = Route(id=getId(Route, codespace, "A-H-SD"), version=version.version,
                 distance=Decimal('17000'),
                 flexible_line_ref_or_line_ref=getRef(line_hasd),
                   direction_type=DirectionTypeEnumeration.INBOUND,
                   points_in_sequence=PointsOnRouteRelStructure(point_on_route=[
                       PointOnRoute(id=getId(PointOnRoute, codespace, "A-H-SD-H"), version=version.version, order=1, choice_1=getRef(rp_a), onward_route_link_ref=getRef(rl_ah, RouteLinkRefStructure)),
                       PointOnRoute(id=getId(PointOnRoute, codespace, "A-H-SD-A"), version=version.version, order=2, choice_1=getRef(rp_h)),
                   ])
                   )

route_hasd = Route(id=getId(Route, codespace, "L-S-SD"), version=version.version,
                 distance=Decimal('12000'),
                 flexible_line_ref_or_line_ref=getRef(line_lssd),
                   direction_type=DirectionTypeEnumeration.OUTBOUND,
                   points_in_sequence=PointsOnRouteRelStructure(point_on_route=[
                       PointOnRoute(id=getId(PointOnRoute, codespace, "L-S-SD-L"), version=version.version, order=1, choice_1=getRef(rp_l), onward_route_link_ref=getRef(rl_ls, RouteLinkRefStructure)),
                       PointOnRoute(id=getId(PointOnRoute, codespace, "L-S-SD-S"), version=version.version, order=2, choice_1=getRef(rp_s)),
                   ])
                   )

route_ahsd = Route(id=getId(Route, codespace, "S-L-SD"), version=version.version,
                 distance=Decimal('12000'),
                 flexible_line_ref_or_line_ref=getRef(line_lssd),
                   direction_type=DirectionTypeEnumeration.INBOUND,
                   points_in_sequence=PointsOnRouteRelStructure(point_on_route=[
                       PointOnRoute(id=getId(PointOnRoute, codespace, "S-L-SD-S"), version=version.version, order=1, choice_1=getRef(rp_s), onward_route_link_ref=getRef(rl_sl, RouteLinkRefStructure)),
                       PointOnRoute(id=getId(PointOnRoute, codespace, "S-L-SD-L"), version=version.version, order=2, choice_1=getRef(rp_l)),
                   ])
                   )

routes = [route_ha, route_ah, route_ha, route_ah, route_hasd, route_ahsd, route_hasd, route_ahsd]
...
dd_t = DestinationDisplay(id=getId(DestinationDisplay, codespace, "A"), version=version.version,
...
dd_v = DestinationDisplay(id=getId(DestinationDisplay, codespace, "L"), version=version.version,
...
dd_v = DestinationDisplay(id=getId(DestinationDisplay, codespace, "S"), version=version.version,
...
sa_a = StopArea(id=getId(StopArea, codespace, "A"),
                 version=version.version,
                 name=MultilingualString(value="Ameland"),
...
sa_l = StopArea(id=getId(StopArea, codespace, "L"),
                 version=version.version,
...
sa_s = StopArea(id=getId(StopArea, codespace, "S"),
                 version=version.version,
                 name=MultilingualString(value="Schiermonnikoog"),
...
service_frames = dutchprofile.getServiceFrames(route_points=route_points, route_links=route_links, routes=routes, lines=lines,
                                              ...
                                              stop_assignments=stop_assignments, timing_points=None, timing_links=timing_links,
                                               service_journey_patterns=journey_patterns, time_demand_types=time_demand_types,
