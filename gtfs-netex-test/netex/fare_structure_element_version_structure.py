...
class FareStructureElementVersionStructure(PriceableObjectVersionStructure):
    ...
    fare_quota_factor_ref_or_fare_demand_factor_ref_or_quality_structure_factor_ref_or_quality_structure_factors: Optional[Union[FareQuotaFactorRef, FareDemandFactorRef, QualityStructureFactorRef, QualityStructureFactorsRelStructure]] = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
    ...
    distance_matrix_element_ref_or_distance_matrix_elements_or_group_of_distance_matrix_elements_ref_or_group_of_distance_matrix_elements: Optional[Union[DistanceMatrixElementRef, DistanceMatrixElementsRelStructure, GroupOfDistanceMatrixElementsRef, GroupOfDistanceMatrixElements]] = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
