...
class ParkingBayRefsRelStructure(OneToManyRelationshipStructure):
    ...
    parking_bay_ref_or_vehicle_sharing_parking_bay_ref: list[Union[VehiclePoolingParkingBayRef, MonitoredVehicleSharingParkingBayRef, VehicleSharingParkingBayRef, ParkingBayRef]] = field(
