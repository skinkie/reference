        ...
        for sj in self.service_journeys:
            ...
            # if there are calls -> create service journey patterns
                ...
                if not sj.choice:
                    ...
                    call: Call
                    spijps = [self.mapCallToStopPointInJourneyPattern(call) for call in sj.calls.choice]
                    ...
                    if len(spijps) > 0:
                        service_journey_pattern.points_in_sequence = PointsInJourneyPatternRelStructure(point_in_journey_pattern_or_stop_point_in_journey_pattern_or_timing_point_in_journey_pattern=spijps)
