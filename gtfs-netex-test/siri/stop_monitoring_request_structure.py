...
class StopMonitoringRequestStructure(AbstractFunctionalServiceRequestStructure):
    ...
    minimum_stop_visits_per_line_or_minimum_stop_visits_per_line_via: Optional[Union["StopMonitoringRequestStructure.MinimumStopVisitsPerLine", "StopMonitoringRequestStructure.MinimumStopVisitsPerLineVia"]] = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
                {
                    ...
                    "type": ForwardRef("StopMonitoringRequestStructure.MinimumStopVisitsPerLine"),
                    "namespace": "http://www.siri.org.uk/siri",
                },
                {
                    "name": "MinimumStopVisitsPerLineVia",
                    "type": ForwardRef("StopMonitoringRequestStructure.MinimumStopVisitsPerLineVia"),
                    "namespace": "http://www.siri.org.uk/siri",
                },
            ),
        },
